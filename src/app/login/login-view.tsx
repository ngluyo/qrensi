...
export function LoginView({ namaAplikasi, namaOrganisasi }: { namaAplikasi: string; namaOrganisasi: string }) {
  return (
    <main className="flex flex-1 flex-col justify-center px-6 py-12">
      <div className="mx-auto w-full max-w-sm">
        <div className="mb-8 text-center">
          <h1 className="text-2xl font-extrabold tracking-tight">Masuk ke {namaAplikasi}</h1>
          <p className="mt-1 text-sm text-muted">{namaOrganisasi}</p>
        </div>
